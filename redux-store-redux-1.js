...
vez que reciba un cambio pueda hacer un store.getState OJO: me suscribo después de hacer el dispatch. yo aquí lo que estoy haciendo es suscribirme cada vez que pueda al sotre y cada vez que detecta en un cambio en la store pues hago un getState() > Esto es interesante por que es lo que le va permitir actualizar la UI cada que encontremos un cambio en el state de forma que podeamos relfejar en algún sitio que ha cambiado el state. 
